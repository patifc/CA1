var gEntreeCount = 0;
										...
										// item prices.
function calculateBill(idPuppyList) {
	var fBillTotal = 0.0;
	var i=0;
	
										// find the table tag
	var oTable = document.getElementById(idPuppyList);
...
function highlightAvailable(idTable, bShowAvailable) {
	...
	for (i=0; i < aTRs.length; i++) {
		if (aTRs[i].getAttribute('available') && aTRs[i].getAttribute('available') == "true") {
			if (bShowAvailable){
